...
In order to play, the files must be placed on a web server and loaded in a browser of your chosing.

My goal in this project was to get as close to pixel perfect as possible. And I think it's fairly close, but there are some very slight inconsistencies still. The game includes all credit/title scenes and cut scenes for both Pac-Man and Ms Pac-Man.
